                                ...
                                case AuthResult.ArtistAuthenticated:
                                    ...
                                    while (ArtistLoop)
                                    {
                                        ...
                                        switch (num5)
                                        {
                                            ...
                                            case 5:
                                                Console.WriteLine("╔════════════════════════════════════════╗");
                                                Console.WriteLine("║          Artist Profile Information       ║");
                                                Console.WriteLine("╠════════════════════════════════════════╣");
                                                Console.WriteLine($"║ First Name    : {ArtistProfile.FirstName} ║");
                                                Console.WriteLine($"║ Last Name     : {ArtistProfile.LastName} ║");
                                                Console.WriteLine($"║ Email         : {ArtistProfile.Email} ║");
                                                Console.WriteLine($"║ Password      : {ArtistProfile.Password} ║");
                                                Console.WriteLine($"║ Balance       : {ArtistProfile.Balance} ║"); // Format as currency
                                                Console.WriteLine($"║ Phone Number  : {ArtistProfile.PhoneNumber} ║");
                                                Console.WriteLine("╚════════════════════════════════════════╝");
